...
def unpack_sample( s ):
    ...
    for i in range(sl):
        ix = i*2
        us.append(float(wave.struct.unpack_from('h',s,ix)[0]))
    return us
    
def pack_sample( s ):
    sample = ''
    for i in range(len(s)):
        sample += wave.struct.pack('h', int(s[i]))
    return sample
...
def gen_note( note = "C4", sr = 44100.0, t = 5.0, max_amp = global_max_amp, dyn = "f", voice = 0 ):
    ...
    if max_amp > 0.0:
        ...
        if cs:      
            ...
            time_axis = map(lambda x: float(x)*natural_freq, range(int(period)))
            #evaluate singal amplitudes for the period
            period_amp_data = map(lambda x: math.sin(x), time_axis)
...
if __name__ == '__main__':
    ...
    init_sample_cache("./ssamples")
    init_sample_cache("./gsamples",1)
    
#    s = Song( True, 120, 4, 4,
#        [
#        C("C3Min7",1),C("C3-Maj7",1),C("C3Min7",1),C("C3Min6",1),
#        C("Ab3Maj7",1),C("F3Min7",1),C("D3Min7b5",1),C("G37b9",1),
#        C("C3Min7",1),C("C3-Maj7",1),C("C3Min7",1),C("C3Min6",1),
#        C("Ab3Maj7",1),C("F3Min7",1),C("Ab3Min6",1),C("Bb37b9",1),
#        C("Db3Maj7",2),C("F3Min7",2),C("G3Min7",2),C("F3Min7",2),C("Eb3Maj7",2),C("F3Min7",2),C("G3Min7",2),C("F3Min7",2),
#        C("Eb3Maj7",2),C("G37",2),C("C3Min7",2),C("Bb3Min7",4),C("A37",4),C("Ab3Maj7",1),C("D3Min7b5",2),C("G37b9",2),
#        C("C3Min7",1),C("C3-Maj7",1),C("C3Min7",1),C("C3Min6",1),
#        C("Ab3Maj7",1),C("D3Min7b5",2),C("G37b9",2),C("C3Min7",1),C("Bb3Min7",2),C("A37#11",2),
#        C("Ab3Maj7",1),C("F3Min7",2),C("Bb37b9",2),C("Eb37",1),C("D3Min7b5",2),C("G37b9",2)
#        ] * 3,
#        [
#        N("C3",2),N("D3",4),N("Eb3",4),
#        N("D3",4.5),N("Eb3",8),N("D3",2),
#        N("C3",2),N("D3",4),N("Eb3",4),
#        N("D3",4.5),N("Eb3",8),N("D3",2),
#        N("C3",2),N("D3",4),N("Eb3",4),
#        N("Bb3",2),N("Ab3",4),N("G3",4),
#        N("F3",1),
#        N("F3",1),
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("F3",4.5),N("G3",8),N("F3",2),
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("F3",4.5),N("G3",8),N("F3",2),
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("D4",4.5),N("C4",8),N("Bb3",4.5),N("A3",8),
#        N("Ab3",1),
#        N("Ab3",2),N("G3",4),N("F3",4),
#        N("Bb3",4.5),N("Eb3",8),N("Eb3",4),N("D3",4),
#        N("Eb3",2),N("Eb3",4),N("D3",4),
#        N("C4",4.5),N("Eb3",8),N("Eb3",4),N("D3",4),
#        N("Eb3",2),N("Eb3",4),N("D3",4),
#        N("D4",4.5),N("Eb3",8),N("Eb3",4),N("D3",4),
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("C4",1),
#        N("C4",2),N("D3",2),
#        N("C3",2),N("D3",4),N("Eb3",4),
...
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("F3",4.5),N("G3",8),N("F3",2),
#        N("C4",2),N("D4",4),N("Eb4",4),
#        N("D4",4.5),N("Eb4",8),N("D4",2),
#        N("Eb4",1),
#        N("Eb4",1),
#        N("Eb3",2),N("F3",4),N("G3",4),
#        N("F3",4.5),N("G3",8),N("F3",2),
...
#    s = Song( False, 120, 4,4,
#        [
#        C("E37",1),C("E37",1),C("E37",1),C("E37",1),
#        C("A37",1),C("A37",1),C("E37",1),C("E37",1),
#        C("B37",1),C("A37",1),C("E37",1),C("E37",1)
#        ] * 3,
#        [
...
#        )
    ...
    s.melody = improvise_ex(s, delta_gen =  DeltaGenerator(deltas))
